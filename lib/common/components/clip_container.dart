...
// CustomPaint(
//     size: Size(WIDTH, (WIDTH*0.5116959064327485).toDouble()), //You can Replace [WIDTH] with your desired width for Custom Paint and height will be calculated automatically
...
class ClipContainer extends CustomPainter {
    @override
...
Path path_0 = Path();
    ...
    path_0.cubicTo(size.width*0.9481257,size.height*0.3765817,size.width*0.9720351,size.height*0.3873766,size.width*0.9860175,size.height*0.4217326);
...
paint_0_fill.shader = ui.Gradient.linear(Offset(0,size.height*0.7314286), Offset(size.width*1.035503,size.height*0.7314286), [Color(0xff5936B4).withOpacity(1),Color(0xff362A84).withOpacity(1)], [0,1]);
